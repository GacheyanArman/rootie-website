  ...
  return (
    <section id="gallery" className="mx-auto max-w-[1600px] px-4 py-24 md:px-8 md:py-36">
      ...
      <div className="mt-16 grid gap-4 md:mt-24 md:grid-cols-12 md:grid-rows-[360px_360px]">
        <figure className="group relative min-h-96 overflow-hidden md:col-span-8 md:row-span-2"><Image src="/images/sneaker-wall-nike.png" alt={t.gallery.alts[0]} fill sizes="(min-width:768px) 66vw, 100vw" className="object-cover transition-transform duration-700 group-hover:scale-105" /><figcaption className="absolute bottom-4 left-4 bg-background px-3 py-2 text-xs font-bold uppercase tracking-widest">Sneaker room / 01</figcaption></figure>
        <figure className="group relative min-h-72 overflow-hidden md:col-span-4"><Image src="/images/store-counter.png" alt={t.gallery.alts[1]} fill sizes="(min-width:768px) 34vw, 100vw" className="object-cover transition-transform duration-700 group-hover:scale-105" /></figure>
