...
export const translations = {
  ru: {
    ...
    productModal: {
      ...
      sizes: 'Размеры',
      close: 'Закрыть',
      viewOn: 'Открыть в Instagram',
    },
    adminForm: {
      loginTitle: 'Вход',
      loginDesc: 'Введите пароль администратора для доступа к управлению каталогом.',
      loginSubmit: 'Войти',
      loginError: 'Неверный пароль',
      backToSite: 'Вернуться на сайт',
      logout: 'Выйти',
      pageTitle: 'Управление каталогом',
      pageDesc: 'Выберите фотографию с телефона или компьютера и заполните карточку товара.',
      photo: 'Фотография',
      preparingPhoto: 'Подготавливаем фото',
      preparingDesc: 'Уменьшаем размер без заметной потери качества.',
      replacePhoto: 'Заменить фото',
      choosePhoto: 'Выберите фото',
      chooseDesc: 'Нажмите сюда или перетащите изображение. Оно автоматически уменьшится и загрузится в каталог.',
      ...
      featured: 'Показывать первым',
      featuredDesc: 'Товар будет закреплён в начале каталога.',
      password: 'Пароль администратора',
      passwordPlaceholder: 'Введите пароль',
      submit: 'Добавить в каталог',
      clear: 'Очистить',
      addedItems: 'Добавленные товары',
      refresh: 'Обновить',
      loadingCatalog: 'Загружаем каталог…',
      emptyCatalog: 'Здесь появятся товары, добавленные через эту страницу.',
      noCategory: 'Без категории',
      featuredBadge: 'Первым',
      loadingUpload: 'Загружаем фото и добавляем товар…',
    },
  },
  en: {
    nav: {
    ...
    adminForm: {
      loginTitle: 'Login',
      loginDesc: 'Enter the admin password to access catalog management.',
      loginSubmit: 'Log in',
      loginError: 'Invalid password',
      backToSite: 'Back to website',
      logout: 'Log out',
      pageTitle: 'Catalog Management',
      pageDesc: 'Choose a photo from your phone or computer and fill out the product details.',
      photo: 'Photo',
      preparingPhoto: 'Preparing photo',
      preparingDesc: 'Reducing size without noticeable quality loss.',
      replacePhoto: 'Replace photo',
      choosePhoto: 'Choose photo',
      chooseDesc: 'Click here or drag an image. It will be automatically compressed and uploaded to the catalog.',
      ...
      optional: 'optional',
      featured: 'Show first',
      featuredDesc: 'The product will be pinned at the top of the catalog.',
      ...
      emptyCatalog: 'Products added through this page will appear here.',
      noCategory: 'No category',
      featuredBadge: 'First',
      loadingUpload: 'Uploading photo and adding product...',
    },
  },
  hy: {
    nav: {
    ...
    productModal: {
      ...
      sizes: 'Չափսեր',
      close: 'Փակել',
      viewOn: 'Դիտել Instagram-ում',
    },
    adminForm: {
      loginTitle: 'Մուտք',
      loginDesc: 'Մուտքագրեք ադմինիստրատորի գաղտնաբառը՝ կատալոգի կառավարմանը հասանելիություն ստանալու համար։',
      loginSubmit: 'Մուտք գործել',
      loginError: 'Սխալ գաղտնաբառ',
      backToSite: 'Վերադառնալ կայք',
      logout: 'Դուրս գալ',
      pageTitle: 'Կատալոգի Կառավարում',
      pageDesc: 'Ընտրեք լուսանկար ձեր հեռախոսից կամ համակարգչից և լրացրեք ապրանքի տվյալները։',
      photo: 'Լուսանկար',
      preparingPhoto: 'Լուսանկարի նախապատրաստում',
      preparingDesc: 'Նվազեցնում ենք չափը առանց որակի նկատելի կորստի։',
      replacePhoto: 'Փոխել լուսանկարը',
      choosePhoto: 'Ընտրել լուսանկար',
      chooseDesc: 'Սեղմեք այստեղ կամ քաշեք նկարը։ Այն ինքնաբերաբար կփոքրացվի և կներբեռնվի կատալոգ։',
      info: 'Ապրանքի Տեղեկություն',
      name: 'Անվանում',
      category: 'Կատեգորիա',
      price: 'Գինը, ֏',
      stock: 'Առկայություն',
      ...
      featured: 'Ցուցադրել առաջինը',
      featuredDesc: 'Ապրանքը կամրացվի կատալոգի սկզբում։',
      password: 'Ադմինիստրատորի գաղտնաբառ',
      passwordPlaceholder: 'Մուտքագրեք գաղտնաբառը',
      submit: 'Ավելացնել կատալոգում',
      clear: 'Մաքրել',
      addedItems: 'Ավելացված ապրանքներ',
      refresh: 'Թարմացնել',
      loadingCatalog: 'Կատալոգի բեռնում...',
      emptyCatalog: 'Այս էջի միջոցով ավելացված ապրանքները կհայտնվեն այստեղ։',
      noCategory: 'Առանց կատեգորիայի',
      featuredBadge: 'Առաջինը',
      loadingUpload: 'Ներբեռնում ենք լուսանկարը և ավելացնում ապրանքը...',
    },
  },
} as const
